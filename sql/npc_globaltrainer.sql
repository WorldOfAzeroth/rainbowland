...
-- Creature Text
DELETE FROM `creature_text` WHERE `CreatureID` = @Trainer;
INSERT INTO `creature_text` (`CreatureID`, `GroupID`, `ID`, `Text`, `Type`, `Language`, `Probability`, `Emote`, `Duration`, `Sound`, `BroadcastTextID`, `TextRange`, `comment`) VALUES (@Trainer, '0', '0', 'Greetings Traveler. Stay awhile.. and train!', '12', '0', '100', '0', '0', '0', @Trainer, '0', '');

-- Broadcast Text
DELETE FROM `broadcast_text` WHERE `ID` = @Trainer;
INSERT INTO `broadcast_text` (`ID`, `Language`, `MaleText`, `FemaleText`, `EmoteID0`, `EmoteID1`, `EmoteID2`, `EmoteDelay0`, `EmoteDelay1`, `EmoteDelay2`, `SoundId`, `Unk1`, `Unk2`, `VerifiedBuild`) VALUES (@Trainer, '0', 'Greetings Traveler. Stay awhile.. and train!', '', '0', '0', '0', '0', '0', '0', '0', '0', '1', '12034');

-- Smart Scripts
DELETE FROM `smart_scripts` WHERE `entryorguid` = @Trainer;
